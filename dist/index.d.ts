export declare const GHL: {
    ...
    calendars: {
        ...
        create: (options: import("./types/calendars").CalendarDTO, authToken: string) => Promise<(import("./types/_global").BadRequestDTO | import("./types/_global").UnauthorizedDTO | import("./types/_global").UnprocessableDTO | import("./types/calendars").CalendarByIdSuccessfulResponseDTO) | null>;
        update: (calendarId: import("./types/calendars").CalendarDTO["id"], options: Partial<import("./types/calendars").CalendarDTO>, authToken: string) => Promise<(import("./types/_global").BadRequestDTO | import("./types/_global").UnauthorizedDTO | import("./types/_global").UnprocessableDTO | import("./types/calendars").CalendarByIdSuccessfulResponseDTO) | null>;
